...
function DocPreview({ setMediaFile, file, isEditMode, attachmentBlock }: DocPreviewInterface) {
  if (isEditMode!) {
    return (
      <div className="previewWrapper">
        <div className="docContent">
          ...
          <div className="docContent__metaDetails">
            <p className="docContent--metaDetails__name">{attachmentBlock?.attachmentMeta.name}</p>
            <p className="docContent--metaDetails__size">
              {getFileSize(attachmentBlock?.attachmentMeta?.size!)}
            </p>
          </div>
        </div>
